...
@property (nonatomic, strong) NSArray *playerRunRightTextures, *playerJumpingRightTextures;
@property (nonatomic, strong) NSArray *playerSkiddingRightTextures, *playerStillFacingRightTextures;
@property (nonatomic, strong) NSArray *playerRunLeftTextures, *playerJumpingLeftTextures;
@property (nonatomic, strong) NSArray *playerSkiddingLeftTextures, *playerStillFacingLeftTextures;
@property (nonatomic, strong) NSArray *ratzRunRightTextures, *ratzRunLeftTextures;
